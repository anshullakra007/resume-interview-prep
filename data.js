      ...
      },
      {
        ...
        "questions": [
          ...
          },
          {
            ...
            "answer": "TCP is a streaming protocol, so messages can be fragmented. I wrap the `Socket.getInputStream()` in a `BufferedReader` or `BufferedInputStream`. The parser waits until it reads the ` ` terminator. If the connection drops mid-command, the stream throws an `IOException` and the partial command is discarded."
          },
          {
            "id": "p1_q25",
